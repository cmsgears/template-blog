...
CREATE TABLE `cmg_cms_block` (
  ...
  CONSTRAINT `fk_cms_block_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
  CONSTRAINT `fk_cms_block_2` FOREIGN KEY (`bannerId`) REFERENCES `cmg_core_file` (`id`),
  CONSTRAINT `fk_cms_block_3` FOREIGN KEY (`textureId`) REFERENCES `cmg_core_file` (`id`),
  CONSTRAINT `fk_cms_block_4` FOREIGN KEY (`videoId`) REFERENCES `cmg_core_file` (`id`),
  CONSTRAINT `fk_cms_block_5` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`),
  CONSTRAINT `fk_cms_block_6` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_cms_block_7` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
...
CREATE TABLE `cmg_cms_page` (
  ...
  CONSTRAINT `fk_cms_page_2` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
  CONSTRAINT `fk_cms_page_3` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_cms_page_4` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cmg_cms_page` VALUES (1,NULL,1,1,1,'Home','home','page',500,10,NULL,0,0),(2,NULL,1,1,1,'Login','login','page',500,10,NULL,0,0),(3,NULL,1,1,1,'Register','register','page',500,10,NULL,0,0),(4,NULL,1,1,1,'Confirm Account','confirm-account','page',500,10,NULL,0,0),(5,NULL,1,1,1,'Activate Account','activate-account','page',500,10,NULL,0,0),(6,NULL,1,1,1,'Forgot Password','forgot-password','page',500,10,NULL,0,0),(7,NULL,1,1,1,'Reset Password','reset-password','page',500,10,NULL,0,0),(8,NULL,1,1,1,'About Us','about-us','page',500,10,NULL,0,0),(9,NULL,1,1,1,'Terms','terms','page',500,10,NULL,0,0),(10,NULL,1,1,1,'Privacy','privacy','page',500,10,NULL,0,0),(11,NULL,1,1,1,'Blog','blog','page',500,10,NULL,0,0);
...
CREATE TABLE `cmg_cms_page_attribute` (
  ...
  CONSTRAINT `fk_cms_page_attribute_1` FOREIGN KEY (`pageId`) REFERENCES `cmg_cms_page` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_activity` (
  ...
  CONSTRAINT `fk_activity_1` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_category` (
  ...
  CONSTRAINT `fk_category_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
...
CREATE TABLE `cmg_core_form` (
  ...
  CONSTRAINT `fk_form_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
  CONSTRAINT `fk_form_2` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`),
  CONSTRAINT `fk_form_3` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_form_4` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
...
INSERT INTO `cmg_core_form` VALUES (1,1,NULL,1,1,'Config Core','config-core','system','Core configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(2,1,NULL,1,1,'Config Mail','config-mail','system','Mail configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(3,1,NULL,1,1,'Config Backend','config-backend','system','Backend site configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(4,1,NULL,1,1,'Config Site','config-frontend','system','Frontend site configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(5,1,NULL,1,1,'Config Facebook','config-facebook','system','Facebook configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(6,1,NULL,1,1,'Config Google','config-google','system','Google configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(7,1,NULL,1,1,'Config Twitter','config-twitter','system','Twitter site configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(8,1,NULL,1,1,'Config File','config-file','system','Facebook configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(9,1,NULL,1,1,'Config Twitter Meta','config-twitter-meta','system','Twitter meta configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(10,1,NULL,1,1,'Config Facebook Meta','config-facebook-meta','system','Facebook meta configuration form.','All configurations saved successfully.',0,10,1,0,0,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(11,1,1,1,1,'Contact Us','contact-us','site','contact form','Contrary to popular belief, Lorem Ipsum is not simply random text.',1,0,1,0,1,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL),(12,1,1,1,1,'Feedback','feedback','site','feedback form','Thanks for providing your valuable feedback.',1,0,1,0,1,'2014-10-11 14:22:54','2014-10-11 14:22:54',NULL,NULL);
...
INSERT INTO `cmg_core_form_field` VALUES (1,1,'locale_message','Locale Message',40,0,'required',0,NULL,'{\"title\":\"Check for i18n support.\"}',NULL),(2,1,'language','Language',0,0,'required',0,NULL,'{\"title\":\"Language used on html tag.\",\"placeholder\":\"Language\"}',NULL),(3,1,'locale','Locale',0,0,'required',0,NULL,'{\"title\":\"Site default locale.\",\"placeholder\":\"Locale\"}',NULL),(4,1,'charset','Charset',0,0,'required',0,NULL,'{\"title\":\"Charset used on html head meta.\",\"placeholder\":\"Charset\"}',NULL),(5,1,'site_title','Site Title',0,0,'required',0,NULL,'{\"title\":\"Site title used in forming page title.\",\"placeholder\":\"Site Title\"}',NULL),(6,1,'site_name','Site Name',0,0,'required',0,NULL,'{\"title\":\"Site name used on footers etc.\",\"placeholder\":\"Site Name\"}',NULL),(7,1,'site_url','Frontend URL',0,0,'required',0,NULL,'{\"title\":\"Frontend URL\",\"placeholder\":\"Frontend URL\"}',NULL),(8,1,'admin_url','Backend URL',0,0,'required',0,NULL,'{\"title\":\"Backend URL\",\"placeholder\":\"Backend URL\"}',NULL),(9,1,'registration','Registration',40,0,'required',0,NULL,'{\"title\":\"Check whether site registration is allowed.\"}',NULL),(10,1,'change_email','Change Email',40,0,'required',0,NULL,'{\"title\":\"Check whether email change is allowed for user profile.\"}',NULL),(11,1,'change_username','Change Username',40,0,'required',0,NULL,'{\"title\":\"Check whether username change is allowed for user profile.\"}',NULL),(12,1,'date_format','Date Format',0,0,'required',0,NULL,'{\"title\":\"Date format used by the formatter.\",\"placeholder\":\"Date Format\"}',NULL),(13,1,'time_format','Time Format',0,0,'required',0,NULL,'{\"title\":\"Time format used by the formatter.\",\"placeholder\":\"Time Format\"}',NULL),(14,1,'timezone','Timezone',0,0,'required',0,NULL,'{\"title\":\"Time format used by the formatter.\",\"placeholder\":\"Time Format\"}',NULL),(15,2,'smtp','SMTP',40,0,'required',0,NULL,'{\"title\":\"Check whether SMTP is required.\"}',NULL),(16,2,'smtp_username','SMTP Username',0,0,NULL,0,NULL,'{\"title\":\"SMTP username.\",\"placeholder\":\"SMTP Username\"}',NULL),(17,2,'smtp_password','SMTP Password',10,0,NULL,0,NULL,'{\"title\":\"SMTP password.\",\"placeholder\":\"SMTP Password\"}',NULL),(18,2,'smtp_host','SMTP Host',0,0,NULL,0,NULL,'{\"title\":\"SMTP host.\",\"placeholder\":\"SMTP Host\"}',NULL),(19,2,'smtp_port','SMTP Port',0,0,NULL,0,NULL,'{\"title\":\"SMTP port.\",\"placeholder\":\"SMTP Port\"}',NULL),(20,2,'smtp_encryption','SMTP Encryption',0,0,NULL,0,NULL,'{\"title\":\"SMTP encryption.\",\"placeholder\":\"SMTP Encryption\"}',NULL),(21,2,'debug','SMTP Debug',40,0,'required',0,NULL,'{\"title\":\"Check whether SMTP debug is required.\"}',NULL),(22,2,'sender_name','Sender Name',0,0,'required',0,NULL,'{\"title\":\"Sender name.\",\"placeholder\":\"Sender Name\"}',NULL),(23,2,'sender_email','Sender Email',0,0,'required',0,NULL,'{\"title\":\"Sender email.\",\"placeholder\":\"Sender Email\"}',NULL),(24,2,'contact_name','Contact Name',0,0,'required',0,NULL,'{\"title\":\"Contact name.\",\"placeholder\":\"Contact Name\"}',NULL),(25,2,'contact_email','Contact Email',0,0,'required',0,NULL,'{\"title\":\"Contact email.\",\"placeholder\":\"Contact Email\"}',NULL),(26,2,'info_name','Info Name',0,0,'required',0,NULL,'{\"title\":\"Info name.\",\"placeholder\":\"Info Name\"}',NULL),(27,2,'info_email','Info Email',0,0,'required',0,NULL,'{\"title\":\"Info email.\",\"placeholder\":\"Info Email\"}',NULL),(28,5,'active','Active',40,0,'required',0,NULL,'{\"title\":\"Check whether Facebook Login is active.\"}',NULL),(29,5,'app_id','Application Id',0,0,'required',0,NULL,'{\"title\":\"Application Id.\",\"placeholder\":\"Application Id\"}',NULL),(30,5,'app_secret','Application Secret',10,0,'required',0,NULL,'{\"title\":\"Application Secret.\",\"placeholder\":\"Application Secret\"}',NULL),(31,5,'redirect_uri','Redirect URI',0,0,'required',0,NULL,'{\"title\":\"Redirect URI.\",\"placeholder\":\"Redirect URI\"}',NULL),(32,6,'active','Active',40,0,'required',0,NULL,'{\"title\":\"Check whether Google Login is active.\"}',NULL),(33,6,'app_id','Application Id',0,0,'required',0,NULL,'{\"title\":\"Application Id.\",\"placeholder\":\"Application Id\"}',NULL),(34,6,'app_secret','Application Secret',10,0,'required',0,NULL,'{\"title\":\"Application Secret.\",\"placeholder\":\"Application Secret\"}',NULL),(35,6,'redirect_uri','Redirect URI',0,0,'required',0,NULL,'{\"title\":\"Redirect URI.\",\"placeholder\":\"Redirect URI\"}',NULL),(36,7,'active','Active',40,0,'required',0,NULL,'{\"title\":\"Check whether Google Login is active.\"}',NULL),(37,7,'api_key','API Id',0,0,'required',0,NULL,'{\"title\":\"API Key.\",\"placeholder\":\"API Key\"}',NULL),(38,7,'api_secret','API Secret',10,0,'required',0,NULL,'{\"title\":\"API Secret.\",\"placeholder\":\"API Secret\"}',NULL),(39,7,'redirect_uri','Redirect URI',0,0,'required',0,NULL,'{\"title\":\"Redirect URI.\",\"placeholder\":\"Redirect URI\"}',NULL),(40,8,'image_extensions','Image Extensions',0,0,'required',0,NULL,'{\"title\":\"Image Extensions.\",\"placeholder\":\"Image Extensions\"}',NULL),(41,8,'video_extensions','Video Extensions',0,0,'required',0,NULL,'{\"title\":\"Video Extensions.\",\"placeholder\":\"Video Extensions\"}',NULL),(42,8,'audio_extensions','Audio Extensions',0,0,'required',0,NULL,'{\"title\":\"Audio Extensions.\",\"placeholder\":\"Audio Extensions\"}',NULL),(43,8,'document_extensions','Document Extensions',0,0,'required',0,NULL,'{\"title\":\"Document Extensions.\",\"placeholder\":\"Document Extensions\"}',NULL),(44,8,'compressed_extensions','Compressed Extensions',0,0,'required',0,NULL,'{\"title\":\"Compressed Extensions.\",\"placeholder\":\"Compressed Extensions\"}',NULL),(45,8,'generate_name','Generate Name',40,0,'required',0,NULL,'{\"title\":\"Generate Name.\"}',NULL),(46,8,'pretty_name','Pretty Name',40,0,'required',0,NULL,'{\"title\":\"Pretty Name.\"}',NULL),(47,8,'max_size','Max Size',0,0,'required',0,NULL,'{\"title\":\"Max Size.\",\"placeholder\":\"Max Size\"}',NULL),(48,8,'generate_thumb','Generate Thumb',40,0,'required',0,NULL,'{\"title\":\"Generate Thumb.\"}',NULL),(49,8,'thumb_width','Thumb Width',0,0,'required',0,NULL,'{\"title\":\"Thumb Width.\",\"placeholder\":\"Thumb Width\"}',NULL),(50,8,'thumb_height','Thumb Height',0,0,'required',0,NULL,'{\"title\":\"Thumb Height.\",\"placeholder\":\"Thumb Height\"}',NULL),(51,8,'uploads_directory','Uploads Directory',0,0,NULL,0,NULL,'{\"title\":\"Uploads Directory.\",\"placeholder\":\"Uploads Directory\"}',NULL),(52,8,'uploads_url','Uploads URL',0,0,'required',0,NULL,'{\"title\":\"Uploads URL.\",\"placeholder\":\"Uploads URL\"}',NULL),(53,9,'active','Active',40,0,'required',0,NULL,'{\"title\":\"activate or de-activate.\"}',NULL),(54,9,'page','Page',40,0,'required',0,NULL,'{\"title\":\"enable or disabled for all pages.\"}',NULL),(55,9,'post','Post',40,0,'required',0,NULL,'{\"title\":\"enable or disabled for all posts.\"}',NULL),(56,9,'card','Card',80,0,'required',0,NULL,'{\"title\":\"Card types\",\"items\":[\"summary\",\"summary_large_image\",\"photo\",\"gallery\",\"product\",\"app\",\"player\"]}',NULL),(57,9,'site','Site',0,0,NULL,0,NULL,'{\"title\":\"@username for the website used in the card footer\",\"placeholder\":\"@username\"}',NULL),(58,9,'creator','Creator',0,0,NULL,0,NULL,'{\"title\":\"@username for the content creator / author.\",\"placeholder\":\"@username\"}',NULL),(59,10,'active','Active',40,0,'required',0,NULL,'{\"title\":\"activate or de-activate.\"}',NULL),(60,10,'page','Page',40,0,'required',0,NULL,'{\"title\":\"enable or disabled for all pages.\"}',NULL),(61,10,'post','Post',40,0,'required',0,NULL,'{\"title\":\"enable or disabled for all posts.\"}',NULL),(62,10,'app_id','Application Id',0,0,'required',0,NULL,'{\"title\":\"fb app id\",\"placeholder\":\"fb app id\"}',NULL),(63,10,'author','Author',0,0,NULL,0,NULL,'{\"title\":\"author\",\"placeholder\":\"author\"}',NULL),(64,10,'publisher','Publisher',0,0,NULL,0,NULL,'{\"title\":\"publisher\",\"placeholder\":\"publisher\"}',NULL),(65,11,'name','Name',0,0,'required',0,NULL,'{\"placeholder\":\"Name\"}',NULL),(66,11,'email','Email',0,0,'required,email',0,NULL,'{\"placeholder\":\"Email\"}',NULL),(67,11,'subject','Subject',0,0,'required',0,NULL,'{\"placeholder\":\"Subject\"}',NULL),(68,11,'message','Message',10,0,NULL,0,NULL,'{\"placeholder\":\"Message\"}',NULL),(69,12,'name','Name',0,0,'required',0,NULL,'{\"placeholder\":\"Name\"}',NULL),(70,12,'email','Email',0,0,'required,email',0,NULL,'{\"placeholder\":\"Email\"}',NULL),(71,12,'message','Message',10,0,NULL,0,NULL,'{\"placeholder\":\"Message\"}',NULL),(72,12,'rating','Rating',90,0,'required',0,NULL,'{\"placeholder\":\"Rating\"}',NULL);
...
CREATE TABLE `cmg_core_gallery` (
  ...
  `data` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `fk_gallery_1` (`siteId`),
  KEY `fk_gallery_2` (`templateId`),
  KEY `fk_gallery_3` (`createdBy`),
  KEY `fk_gallery_4` (`modifiedBy`),
  CONSTRAINT `fk_gallery_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
  CONSTRAINT `fk_gallery_2` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`),
  CONSTRAINT `fk_gallery_3` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_gallery_4` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_model_activity` (
  ...
  CONSTRAINT `fk_model_activity_1` FOREIGN KEY (`activityId`) REFERENCES `cmg_core_activity` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cmg_core_model_attribute` VALUES (1,1,'site','locale_message','Locale Message','core','flag','0'),(2,1,'site','language','Language','core','text','en-US'),(3,1,'site','locale','Locale','core','text','en_US'),(4,1,'site','charset','Charset','core','text','UTF-8'),(5,1,'site','site_title','Site Title','core','text','CMG Demo'),(6,1,'site','site_name','Site Name','core','text','CMSGears'),(7,1,'site','site_url','Site Url','core','text','http://demo.cmsgears.com/templates/blog/'),(8,1,'site','admin_url','Admin Url','core','text','http://demo.cmsgears.com/templates/blog/admin/'),(9,1,'site','registration','Registration','core','flag','1'),(10,1,'site','change_email','Change Email','core','flag','1'),(11,1,'site','change_username','Change Username','core','flag','1'),(12,1,'site','date_format','Date Format','core','text','yyyy-MM-dd'),(13,1,'site','time_format','Time Format','core','text','HH:mm:ss'),(14,1,'site','timezone','Timezone','core','text','UTC+0'),(15,1,'site','smtp','SMTP','mail','flag','0'),(16,1,'site','smtp_username','SMTP Username','mail','text',''),(17,1,'site','smtp_password','SMTP Password','mail','text',''),(18,1,'site','smtp_host','SMTP Host','mail','text',''),(19,1,'site','smtp_port','SMTP Port','mail','text','587'),(20,1,'site','smtp_encryption','SMTP Encryption','mail','text','tls'),(21,1,'site','debug','Debug','mail','flag','1'),(22,1,'site','sender_name','Sender Name','mail','text','Admin'),(23,1,'site','sender_email','Sender Email','mail','text','demoadmin@cmsgears.com'),(24,1,'site','contact_name','Contact Name','mail','text','Contact Us'),(25,1,'site','contact_email','Contact Email','mail','text','democontact@cmsgears.com'),(26,1,'site','info_name','Info Name','mail','text','Info'),(27,1,'site','info_email','Info Email','mail','text','demoinfo@cmsgears.com'),(28,1,'site','image_extensions','Image Extensions','file','text','png,jpg,jpeg,gif'),(29,1,'site','video_extensions','Video Extensions','file','text','mp4,flv,ogv,avi'),(30,1,'site','audio_extensions','Audio Extensions','file','text','mp3,m4a,wav'),(31,1,'site','document_extensions','Document Extensions','file','text','pdf,doc,docx,xls,xlsx,txt'),(32,1,'site','compressed_extensions','Compressed Extensions','file','text','rar,zip'),(33,1,'site','generate_name','Generate Name','file','flag','1'),(34,1,'site','pretty_name','Pretty Name','file','flag','0'),(35,1,'site','max_size','Max Size','file','text','5'),(36,1,'site','generate_thumb','Generate Thumb','file','flag','1'),(37,1,'site','thumb_width','Thumb Width','file','text','120'),(38,1,'site','thumb_height','Thumb Height','file','text','120'),(39,1,'site','uploads_directory','Uploads Directory','file','text',NULL),(40,1,'site','uploads_url','Uploads URL','file','text','http://localhost/cmgdemoblog/uploads/'),(41,1,'site','active','Active','twitter-meta','flag','1'),(42,1,'site','page','Page','twitter-meta','flag','1'),(43,1,'site','post','Post','twitter-meta','flag','1'),(44,1,'site','card','Card','twitter-meta','text','summary_large_image'),(45,1,'site','site','Site','twitter-meta','text',NULL),(46,1,'site','creator','Creator','twitter-meta','text',NULL),(47,1,'site','active','Active','facebook-meta','flag','1'),(48,1,'site','page','Page','facebook-meta','flag','1'),(49,1,'site','post','Post','facebook-meta','flag','1'),(50,1,'site','app_id','App Id','facebook-meta','text',NULL),(51,1,'site','author','Author','facebook-meta','text',NULL),(52,1,'site','publisher','Publisher','facebook-meta','text',NULL),(53,1,'site','active','Active','facebook','flag','1'),(54,1,'site','app_id','App Id','facebook','text',''),(55,1,'site','app_secret','App Secret','facebook','text',''),(56,1,'site','redirect_uri','Redirect URI','facebook','text','/sns/facebook/authorise'),(57,1,'site','active','Actrive','google','flag','1'),(58,1,'site','app_id','App Id','google','text',''),(59,1,'site','app_secret','App Secret','google','text',''),(60,1,'site','redirect_uri','Redirect URI','google','text','/sns/google/authorise'),(61,1,'site','active','Active','twitter','flag','1'),(62,1,'site','api_key','API Key','twitter','text',''),(63,1,'site','api_secret','API Secret','twitter','text',''),(64,1,'site','redirect_uri','Redirect URI','twitter','text','/sns/twitter/authorise');
...
CREATE TABLE `cmg_core_model_comment` (
  ...
  CONSTRAINT `fk_model_comment_3` FOREIGN KEY (`baseId`) REFERENCES `cmg_core_model_comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_model_option` (
  ...
  CONSTRAINT `fk_model_option_1` FOREIGN KEY (`optionId`) REFERENCES `cmg_core_option` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_newsletter` (
  ...
  CONSTRAINT `fk_newsletter_1` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`),
  CONSTRAINT `fk_newsletter_2` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_newsletter_3` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_object` (
  ...
  KEY `fk_object_3` (`createdBy`),
  KEY `fk_object_4` (`modifiedBy`),
  CONSTRAINT `fk_object_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`),
  CONSTRAINT `fk_object_2` FOREIGN KEY (`templateId`) REFERENCES `cmg_core_template` (`id`),
  CONSTRAINT `fk_object_3` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_object_4` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
...
CREATE TABLE `cmg_core_site` (
  ...
  KEY `fk_site_3` (`themeId`),
  CONSTRAINT `fk_site_1` FOREIGN KEY (`avatarId`) REFERENCES `cmg_core_file` (`id`),
  CONSTRAINT `fk_site_2` FOREIGN KEY (`bannerId`) REFERENCES `cmg_core_file` (`id`),
  CONSTRAINT `fk_site_3` FOREIGN KEY (`themeId`) REFERENCES `cmg_core_theme` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cmg_core_tag` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_tag_1` (`siteId`),
  CONSTRAINT `fk_tag_1` FOREIGN KEY (`siteId`) REFERENCES `cmg_core_site` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cmg_core_template` VALUES (1,1,1,'Page','page',NULL,'page','Page layout for pages.','default',1,'page/simple',0,'views/templates/page/simple','2016-01-01 17:04:54','2016-01-01 17:06:22',NULL),(2,1,1,'Blog','blog',NULL,'page','Blog layout to view all blog posts or filters(category, author).','default',1,'page/blog',0,'views/templates/page/blog','2016-01-01 17:04:54','2016-01-01 17:06:22',NULL),(3,1,1,'Post','post',NULL,'post','Post layout for posts.','default',1,'post/simple',0,'views/templates/post/simple','2016-01-01 17:04:54','2016-01-01 17:06:22',NULL),(4,1,1,'Form','form',NULL,'form','It can be used to display public forms.','default',1,'form/simple',0,'views/templates/form/simple','2016-01-01 17:04:54','2016-01-01 17:06:22',NULL),(5,1,1,'Text Social','text-social',NULL,'widget','It can be used to display key values for social links.','default',1,NULL,0,'views/templates/widget/text/social','2016-01-01 17:04:54','2016-01-01 17:06:22',NULL);
...
CREATE TABLE `cmg_core_theme` (
  ...
  `data` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
  KEY `fk_theme_1` (`createdBy`),
  KEY `fk_theme_2` (`modifiedBy`),
  CONSTRAINT `fk_theme_1` FOREIGN KEY (`createdBy`) REFERENCES `cmg_core_user` (`id`),
  CONSTRAINT `fk_theme_2` FOREIGN KEY (`modifiedBy`) REFERENCES `cmg_core_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cmg_core_theme` VALUES (1,0,NULL,'Blog','blog','Blog Theme.',NULL,'@themes/blog','2016-01-01 17:04:54','2016-01-01 17:06:22',NULL);
...
INSERT INTO `cmg_core_user` VALUES (1,NULL,NULL,NULL,750,'demomaster@cmsgears.com','demomaster','$2y$13$Ut5b2RskRpGA9Q0nKSO6Xe65eaBHdx/q8InO8Ln6Lt3HzOK4ECz8W','demo','master',NULL,NULL,NULL,NULL,NULL,NULL,'2014-10-11 14:22:54','2014-10-10 08:03:19',NULL,'JuL37UBqGpjnA7kaPiRnlsiWRwbRvXx7',NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,750,'demoadmin@cmsgears.com','demoadmin','$2y$13$Ut5b2RskRpGA9Q0nKSO6Xe65eaBHdx/q8InO8Ln6Lt3HzOK4ECz8W','demo','admin',NULL,NULL,NULL,NULL,NULL,NULL,'2014-10-11 14:22:54','2014-10-10 08:03:19',NULL,'SQ1LLCWEPva4IKuQklILLGDpmUTGzq8E',NULL,NULL,NULL,NULL),(3,NULL,NULL,NULL,750,'demouser@cmsgears.com','demouser','$2y$13$Ut5b2RskRpGA9Q0nKSO6Xe65eaBHdx/q8InO8Ln6Lt3HzOK4ECz8W','demo','user',NULL,NULL,NULL,NULL,NULL,NULL,'2014-10-11 14:22:54','2014-10-10 08:03:19',NULL,'-jG5ExHS0Y39ucSxHhl3PZ4xmPsfvQFC',NULL,NULL,NULL,NULL);
...
CREATE TABLE `cmg_form_submit` (
  ...
  CONSTRAINT `fk_form_submit_1` FOREIGN KEY (`formId`) REFERENCES `cmg_core_form` (`id`),
...
CREATE TABLE `cmg_sns_profile` (
  ...
  CONSTRAINT `fk_sns_profile_1` FOREIGN KEY (`userId`) REFERENCES `cmg_core_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-03-17 17:43:58
