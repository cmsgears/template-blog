...
call ../../yii migrate/up --migrationPath=@cmsgears/module-sns-login/migrations --interactive=0
call ../../yii migrate/up --migrationPath=@themes/blog/migrations --interactive=0
