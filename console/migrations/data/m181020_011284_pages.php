...
class m181020_011284_pages extends \cmsgears\core\common\base\Migration {
	...
	private function updatePages() {
		...
		$desc = [
			'Blog Demo.',
			'Login at Blog Demo.',
			'Login using OTP at Blog Demo.',
			'Register at Blog Demo to join us.',
			'Confirm Account to continue with Blog Demo',
			'Confirm Account using OTP to continue with Blog Demo',
			'Activate Account',
			'Submit request to change password',
			'Reset Password',
			'Reset Password using OTP',
			'About Us',
			'Terms and Conditions at Blog Demo',
			'Privacy Policy at Blog Demo',
			'Submit Feedback to improve the services provided by Blog Demo',
			'Write us a Testimonial about your experience at Blog Demo',
	...
	private function updatePageContent() {
		...
		$seo = [
			[ null, null, 'Blog Demo', 'index,follow' ],
			[ null, null, 'Blog Demo', 'index,follow' ],
			[ null, null, 'Blog Demo', 'index,follow' ],
			[ null, null, 'Blog Demo', 'index,follow' ],
			[ null, null, 'Blog Demo', 'index,follow' ],
