    ...
    grunt.initConfig({
		...
		sass: {
			dist: {
				...
				files: {
					'../../../frontend/web/blog/ladbtblg-20190402-src.css': '../../../themes/blog/resources/styles/scss/landing.scss',
					'../../../frontend/web/blog/pubbtblg-20190402-src.css': '../../../themes/blog/resources/styles/scss/public.scss',
					'../../../frontend/web/blog/prvbtblg-20190402-src.css': '../../../themes/blog/resources/styles/scss/private.scss'
				}
			}
		},
        concatFa: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/fawbtblg-20190402-src.css'
      		}
    	},
        concatCssCommon: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/cmnbtblg-20190402-src.css'
      		}
    	},
        concatCssLanding: {
      		options: {
      		...
      		dist: {
        		src: [
					'../../../frontend/web/blog/ladbtblg-20190402-src.css'
				],
        		dest: '../../../frontend/web/blog/ladbtblg-20190402-src.css'
      		}
    	},
        concatCssPublic: {
      		options: {
      		...
      		dist: {
        		src: [
					...
					'../../../frontend/web/blog/pubbtblg-20190402-src.css'
				],
        		dest: '../../../frontend/web/blog/pubbtblg-20190402-src.css'
      		}
    	},
        concatCssPrivate: {
      		options: {
      		...
      		dist: {
        		src: [
					...
					'../../../frontend/web/blog/prvbtblg-20190402-src.css'
				],
        		dest: '../../../frontend/web/blog/prvbtblg-20190402-src.css'
      		}
    	},
        concatJsLazy: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/lzybtblg-20190402-src.js'
      		}
    	},
        concatJsCommon: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/cmnbtblg-20190402-src.js'
      		}
    	},
        concatJsLanding: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/ladbtblg-20190402-src.js'
      		}
    	},
        concatJsPublic: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/pubbtblg-20190402-src.js'
      		}
    	},
        concatJsPrivate: {
      		options: {
      		...
      		dist: {
        		...
        		dest: '../../../frontend/web/blog/prvbtblg-20190402-src.js'
      		}
    	},
    	cssmin: {
			options: {
      		...
      		target: {
	        	files: {
					'../../../frontend/web/blog/fawbtblg-20190402.css': [ '../../../frontend/web/blog/fawbtblg-20190402-src.css' ],
					'../../../frontend/web/blog/cmnbtblg-20190402.css': [ '../../../frontend/web/blog/cmnbtblg-20190402-src.css' ],
	          		'../../../frontend/web/blog/ladbtblg-20190402.css': [ '../../../frontend/web/blog/ladbtblg-20190402-src.css' ],
					'../../../frontend/web/blog/pubbtblg-20190402.css': [ '../../../frontend/web/blog/pubbtblg-20190402-src.css' ],
					'../../../frontend/web/blog/prvbtblg-20190402.css': [ '../../../frontend/web/blog/prvbtblg-20190402-src.css' ]
	        	}
      		}
    	},
    	uglify: {
			options: {
      		...
      		main_target: {
	        	files: {
					'../../../frontend/web/blog/lzybtblg-20190402.js': [ '../../../frontend/web/blog/lzybtblg-20190402-src.js' ],
	          		'../../../frontend/web/blog/cmnbtblg-20190402.js': [ '../../../frontend/web/blog/cmnbtblg-20190402-src.js' ],
					'../../../frontend/web/blog/ladbtblg-20190402.js': [ '../../../frontend/web/blog/ladbtblg-20190402-src.js' ],
					'../../../frontend/web/blog/pubbtblg-20190402.js': [ '../../../frontend/web/blog/pubbtblg-20190402-src.js' ],
					'../../../frontend/web/blog/prvbtblg-20190402.js': [ '../../../frontend/web/blog/prvbtblg-20190402-src.js' ]
	        	}
      		}
    	},
		copy: {
